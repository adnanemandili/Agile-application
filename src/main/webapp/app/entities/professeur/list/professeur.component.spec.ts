...
import { sampleWithRequiredData } from '../professeur.test-samples';
...
describe('Professeur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ProfesseurComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.professeurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to professeurService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProfesseurIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProfesseurIdentifier).toHaveBeenCalledWith(entity);
