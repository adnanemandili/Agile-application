...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '80b42d38-8d71-4ce9-8132-5de6898bf4fe' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('cc5ff32d-bc01-488c-8c74-7cb048cb4f17');
      cy.get(`[data-cy="name"]`).should('have.value', 'cc5ff32d-bc01-488c-8c74-7cb048cb4f17');
